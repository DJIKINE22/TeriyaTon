...
<body>
    ...
    <section id="section1">
        <div class="droit">
            ...
            <div class="mess">
                <?php
                    $allmsg = $conn->query("SELECT * FROM tchat limit 10" );
            ...
            <a href="../php/accueil_admin.php"><img src="../img/Retour.png" alt="image" srcset="" style="position:relative; left: 88%;"></a>
        </div>
        <div class="gauche">
            <div class="rows">
                <a href="../php/transfert.php"><img class="icones" src="../img/Transfert.png" alt="image" sizes=""></a>
                <a href="../php/TCHAT1.php"><img class="icones" src="../img/Discution.png" alt="image" sizes=""></a>
